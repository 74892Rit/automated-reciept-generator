...
int main()
{
    ...
    char * newStr;
    newStr = replaceWord(str, "{{item}}", "lenovo ideapad gaming laptop");
    newStr = replaceWord(newStr, "{{outlet}}", "lenovo zone");
    newStr = replaceWord(newStr, "{{name}}", "Rit sir");
    newStr = replaceWord(newStr, "{{outlet}}", "lenovo zone");
